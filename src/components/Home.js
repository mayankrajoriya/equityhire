  ...
  return (
    <div className="home" id="home">
      <section className="hero-section">
        ...
        <a
          href="#readmore"
          className="border border-warning rounded btn text-warning"
        >
          Read More
        </a>
      </section>
      ...
      <div className="container heading" id="readmore">
        <h2 className="head-equity border border-primary rounded-pill">
          Why <span> EquityHire</span>?
        </h2>
      </div>

      <div className="container main-cards" data-aos="zoom-in"
        ...
        <div className="card" style={{ width: "18rem" }}>
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              hiring. That's why we are dedicated to providing tailored
              solutions that align with your vision, values, and budget.
            </p>
          </div>
        </div>
      ...
      <div className="para">
        <p>
          <span>For Startups:</span> Whether you’re a fledgling startup or a
          growing venture, find the talent you need to propel your business
          forward. Let's create something remarkable.{" "}
        </p>
        <p>
          {" "}
          <span>For Talent:</span> Ready to embark on an exhilarating journey
          with a startup? Explore exciting opportunities to work on
          groundbreaking projects and earn equity along the way.
        </p>
      </div>
    </div>
  );
